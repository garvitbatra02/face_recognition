...
def add_in_base(a):
    ...
    # print(dataval)
    r= requests.post(url="https://msbackendfacerec.herokuapp.com/api/foundlocation/addlocation",json=dataval)
    print(r.text)


    newr=requests.get(url=f"https://msbackendfacerec.herokuapp.com/api/missingpeople/getallpersons/{adhaar}");
